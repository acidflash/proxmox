...
cat << EOF |  tee /var/lib/vz/snippets/vendor-lab.yaml
#cloud-config
write_files:
...
landscape:
  client:
    ...
    computer_title: "Testbox"
    url: "https://landscape.labnat.local/message-system"
    ping_url: "http://landscape.labnat.local/ping"
...
qm set $id --cicustom "vendor=local:snippets/vendor-lab.yaml"
